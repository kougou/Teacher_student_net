...
parser.add_argument('--subset_percent', '-p', default=1.0, type=float, help='split data')
...
def train_and_evaluate(model, train_dataloader, val_dataloader, optimizer,
    ...
    for epoch in range(params.num_epochs):
        ...
        if is_best:
            ...
            best_json_path = os.path.join(model_dir, "metrics_val_best_weights_{}.json".format(args.subset_percent))
            utils.save_dict_to_json(val_metrics, best_json_path)

        # Save latest val metrics in a json file in the model directory
        last_json_path = os.path.join(model_dir, "metrics_val_last_weights_{}.json".format(args.subset_percent))
...
if __name__ == '__main__':
    ...
    params.subset_percent = args.subset_percent
